...
# Description
#
#   Coefficients for the IGRF v13 to be used in the function `igrf13syn`.
#
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# 
# This file is from SatelliteToolbox.jl v0.7.3, which is under MIT license.
# 
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

# The IGRF constant array in `igrf13.f` is composed by the concatenation of
     ...
     -29496.57,-1586.42, 4944.26,-2396.06, 3026.34,-2708.54,    # 2010
       ...
       -118.06, -163.17,   -0.01,   -8.03,  101.04,   72.78,    # 2010
        ...
        -14.50,  -20.03,   -5.59,   11.83,  -19.34,  -17.41,    # 2010
         ...
         -0.53,   -0.26,   -0.79,                               # 2010
     -29441.46,-1501.77, 4795.99,-2445.88, 3012.20,-2845.41,    # 2015
       1676.35, -642.17, 1350.33,-2352.26, -115.29, 1225.85,    # 2015
        245.04,  581.69, -538.70,  907.42,  813.68,  283.54,    # 2015
        120.49, -188.43, -334.85,  180.95,   70.38, -329.23,    # 2015
       -232.91,  360.14,   46.98,  192.35,  196.98, -140.94,    # 2015
       -119.14, -157.40,   15.98,    4.30,  100.12,   69.55,    # 2015
         67.57,  -20.61,   72.79,   33.30, -129.85,   58.74,    # 2015
        -28.93,  -66.64,   13.14,    7.35,  -70.85,   62.41,    # 2015
         81.29,  -75.99,  -54.27,   -6.79,  -19.53,   51.82,    # 2015
          5.59,   15.07,   24.45,    9.32,    3.27,   -2.88,    # 2015
        -27.50,    6.61,   -2.32,   23.98,    8.89,   10.04,    # 2015
        -16.78,  -18.26,   -3.16,   13.18,  -20.56,  -14.60,    # 2015
         13.33,   16.16,   11.76,    5.69,  -15.98,   -9.10,    # 2015
         -2.02,    2.26,    5.33,    8.83,  -21.77,    3.02,    # 2015
         10.76,   -3.22,   11.74,    0.67,   -6.74,  -13.20,    # 2015
         -6.88,   -0.10,    7.79,    8.68,    1.04,   -9.06,    # 2015
         -3.89,  -10.54,    8.44,   -2.01,   -6.26,    3.28,    # 2015
          0.17,   -0.40,    0.55,    4.55,   -0.55,    4.40,    # 2015
          1.70,   -7.92,   -0.67,   -0.61,    2.13,   -4.16,    # 2015
          2.33,   -2.85,   -1.80,   -1.12,   -3.59,   -8.72,    # 2015
          3.00,   -1.40,    0.00,   -2.30,    2.11,    2.08,    # 2015
         -0.60,   -0.79,   -1.05,    0.58,    0.76,   -0.70,    # 2015
         -0.20,    0.14,   -2.12,    1.70,   -1.44,   -0.22,    # 2015
         -2.57,    0.44,   -2.01,    3.49,   -2.34,   -2.09,    # 2015
         -0.16,   -1.08,    0.46,    0.37,    1.23,    1.75,    # 2015
         -0.89,   -2.19,    0.85,    0.27,    0.10,    0.72,    # 2015
          0.54,   -0.09,   -0.37,    0.29,   -0.43,    0.23,    # 2015
          0.22,   -0.89,   -0.94,   -0.16,   -0.03,    0.72,    # 2015
         -0.02,   -0.92,   -0.88,    0.42,    0.49,    0.63,    # 2015
          1.56,   -0.42,   -0.50,    0.96,   -1.24,   -0.19,    # 2015
         -0.10,    0.81,    0.42,   -0.13,   -0.04,    0.38,    # 2015
          0.48,    0.08,    0.48,    0.46,   -0.30,   -0.35,    # 2015
         -0.43,   -0.36,   -0.71,                               # 2015
